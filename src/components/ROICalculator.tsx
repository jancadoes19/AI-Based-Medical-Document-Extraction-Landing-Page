            ...
            <form
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-8 py-5 rounded-full border border-slate-200 focus:ring-2 focus:ring-[#063aa4] focus:border-transparent outline-none transition-all text-slate-900 placeholder:text-slate-400 text-lg"
                  value={email}
              ...
              <Button
                variant="primary"
                size="lg"
                className="w-full shadow-lg shadow-[#063aa4]/20 py-5 text-lg">
